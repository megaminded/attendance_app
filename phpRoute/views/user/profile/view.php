...
<head>
    ...
    <link rel="stylesheet" href="/views/assets/css/profile_page.css">
...
<body>
    <nav class="navbar navbar-expand-sm navbar-light  nav fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand text-light" href="<?= route_url("attendance","home")?>"><img src="/views/assets/images/icons/logo.png" alt="logo"
                    width="200"></a>
            <!-- sidebar insidebtn -->
                    ...
                    <div class="col-lg-3  mt-5">
                        ...
                        <div class="offcanvas offcanvas-start mb-3" data-bs-scroll="true" data-bs-backdrop="true"
                            ...
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title" id="offcanvasExampleLabel"> <a
                                        class="navbar-brand text-light" href="/index.html"><img
                                            src="/views/assets/images/icons/logo.png" alt="logo" width="60%"></a>
                                </h5>
                            ...
                            <div class="offcanvas-body">
                                <div class="mx-5">
                                    <a href="<?= route_url("attendance","home")?>" class="text-decoration-none text-dark">
                                        <div class="fw-bold">
                                    ...
                                    <div class="dropdown mt-3">
                                        ...
                                        <ul class="dropdown-menu sidebar-drop-ul " aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item" href="<?= route_url("user","profile")?>">Profile
                                                    Page</a></li>
                        ...
                        <div class="sidecontrol mx-5 d-none d-lg-block mt-3 fw-bold position-fixed ">
                            ...
                            <div class="dropdown mt-2">
                                ...
                                <ul class="dropdown-menu sidebar-drop-ul border-0"
                                    ...
                                    <li class="border-bottom"><a class="dropdown-item text-dark  " href="<?= route_url("user","profile")?>">Profile</a></li>
                                                ...
                                                <div class="col-sm-12 col-md-3 mb-3 mx-2">
                                                    <div class>
                                                        ...
                                                        <a href="#" class="card-img">
                                                            <img class="img mb-1"
                                                                src="/views/assets/images/defaultprofilePic.jpg"
                                                                alt="No image uploaded" width="100%">

                                                        </a>

                                                    </div>
                                                    <a href="<?= route_url("user","profileSettings")?>" class="btn edit-pro btn-sm "
                                                        role="button">Edit
